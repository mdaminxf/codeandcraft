    ...
    <section ref={refAbout} id="about" className="py-16 bg-white">
      ...
      >
        ...
        <div className="w-full lg:w-1/2">
          ...
          I specialize in Java, React, Next.js, MongoDB, and various SQL and NoSQL databases, 
          leveraging the power of these technologies to create robust and scalable web applications. 
          Whether it’s developing powerful backend systems with Java or crafting seamless frontend experiences with React and Next.js,
           my goal is to deliver high-quality, maintainable web app that exceeds expectations.         
