...
const FAQ = () => {
  ...
  return (
    <section className="max-w-3xl mx-auto mt-16 px-4">
      <h3 className="text-2xl font-bold text-zinc-700 mb-6 text-center">Frequently Asked Questions</h3>

      <div className="space-y-4">
        <div>
          <h4
            className="cursor-pointer text-lg font-semibold text-indigo-600 hover:text-indigo-500"
        ...
        <div>
          ...
          >
            Can I hire you for ongoing work?
          </h4>
          {open === 2 && (
            <p className="text-zinc-800 mt-2">
